...
class Investigation(models.Model):
	...
	expert_id = models.ImageField(blank=False, default=0.0)
...
class Subregion(models.Model):
	...
	# go down, then one right, then up, then one right, then down...
...
class Judgement(models.Model):
	...
	date_completed = models.DateField(auto_now_add=False, blank=True)
	time_completed = models.DateField(auto_now_add=False, blank=True)

	time_duration = models.ImageField(blank=False, default=0)
